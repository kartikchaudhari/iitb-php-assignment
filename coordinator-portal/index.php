...
<head>
    ...
    <title>Institute Workshop Coordinator Portal :: Coordinator Login</title>
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center"><i class="fa fa-sign-in"></i>  Coordinator Login</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <form method="post" action="<?=base_url('action.php');?>">
                                ...
                                <button name="btnCoordinatorLogin" type="submit" class="btn btn-success">Submit</button>
